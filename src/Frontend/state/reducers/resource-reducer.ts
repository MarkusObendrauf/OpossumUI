...
export const resourceState = (
  ...
  switch (action.type) {
      ...
      return {
        ...
        ...(action.payload.jumpToUpdatedAttribution && {
          temporaryDisplayPackageInfo:
            updatedManualData.attributions[action.payload.packageInfo.id],
        }),
      };
    case ACTION_DELETE_ATTRIBUTION:
      const manualDataAfterDeletion = deleteManualAttribution(
        state.manualData,
        action.payload,
    ...
    case ACTION_LINK_TO_ATTRIBUTION:
      const manualDataAfterForLinking = linkToAttributionManualData(
        state.manualData,
    ...
    case ACTION_UNLINK_RESOURCE_FROM_ATTRIBUTION:
      const manualDataAfterUnlinking = unlinkResourceFromAttributionId(
        state.manualData,
        action.payload.resourceId,
        action.payload.attributionId,
        getCalculatePreferredOverOriginIds(state),
